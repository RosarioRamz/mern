...
function Editar() {
    ...
    const obtenerUsuarioPorId = async()=>{
        console.log("obtener")
        const response = await axios.get(`http://localhost:3002/paciente/obtenerRegistro/${id}`)

        setTipo(response.data.Tipo)
        setNombreP(response.data.NombreP)
        setApellidosP(response.data.ApellidosP)
        setINE(response.data.INE)
        setCorreo(response.data.Correo)
        setNumeroCasa(response.data.NumeroCasa)
        setSexo(response.data.Sexo)
        setDiaNacimiento(response.data.DiaNacimiento)
        setMesNacimiento(response.data.MesNacimiento)
        setAnioNacimiento(response.data.AnioNacimiento)
        setCiudad(response.data.Ciudad)
        setColonia(response.data.Colonia)
    ...
    const actualizarUsuario = async(e)=>{
        e.preventDefault()
        try {
            await axios.post(`http://localhost:3002/paciente/editarRegistro/${id}`,{
                Tipo,
                NombreP,
                ApellidosP,
                INE,
                                                            ...
                                                            <div class="col py-12">
                                                                <div class="card-body" >
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input value={Direccion} onChange={(e) => setDireccion(e.target.value)} type="Direccion" class="form-control" id="inputPassword" placeholder="Ingresa la dirección" />
                                                                        </div>
                                                                    </div>
                                                                    <br />
                                                                    <div class="form-group row">
